...
# result_product = MathOperations.multiply_numbers(2,3)
#
# print(f"Sum of two number: {result_add}")
# print(f"Product of two number: {result_product}")

# 2. Assignment 2: Class Methods
...
#
#     def Farnenheit_to_Celsius(Farnenheit):
#         return (Farnenheit-32)*5/9
#
#     @classmethod
#     def info(cls):
...
# temp_in_fahrenheit =TemperatureConverter.Celsius_to_Fahrenheit(37)
# temp_in_celsius = TemperatureConverter.Farnenheit_to_Celsius(98.6)
# print(f"37°C in Fahrenheit is: {temp_in_fahrenheit}°F")  # Output: 25°C in Fahrenheit is: 77.0°F
# print(f"98.6°F in Celsius is: {temp_in_celsius}°C")
